...
class CustomPrimaryColor {
  ...
  static const MaterialColor whatsappTeal =
      MaterialColor(_whatsappTealPrimaryValue, <int, Color>{
    50: Color(0xFFE0EBE9),
  ...
  static const MaterialColor whatsappTealAccent =
      MaterialColor(_whatsappTealAccentValue, <int, Color>{
